- @ CNN 在 1980 年代开始就出现了,1998 年 LeNet-5 真正让 CNN 投入应用,但是由于计算量大,所需数据集多一直没有受到关注,直到 2012 年 AlexNet 取得巨大成功让 CNN 重新受到关注 #重点 
- @ 可以说，2012 年是 CNN 乃至整个深度学习领域的关键“引爆点”。在此之后，CNN 迅速成为计算机视觉领域的主流技术，并引发了一系列突破，包括 R-CNN（2014 年）在目标检测领域的革命。

...
[[../../../数学/群论/3.1-从群论到代数]]
# 形式语言
![[attachments/Pasted image 20250415122508.png]]
- `0*`
- `0+0*`
- `ε+00*`
上面三者是等价的, `+` 号是并集
...
![[attachments/Pasted image 20250415124818.png]]
...
**为什么要把语法和语义分割开?**
![[attachments/Pasted image 20250415122946.png]]
阿拉伯数字和罗马数字都是数字, 但是阿拉伯数字计算快得多, 而它们之间的区别仅仅是表达方式
# Lexical Specification
## 数字
![[attachments/Pasted image 20250416015637.png]]
...
![[attachments/Pasted image 20250418140508.png]] 
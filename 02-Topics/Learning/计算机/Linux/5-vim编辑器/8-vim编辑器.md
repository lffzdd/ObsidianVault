...
vi 有三种模式：![[../attachments/Pasted image 20241003212256.png]]
...
| .          | 重做上一个动作                                                                                                                                                             |
## 进入编辑模式
![[../attachments/Pasted image 20241003222531.png]]
## 保存和退出
![[../attachments/Pasted image 20241003223335.png]]
...
## 常用指令示意图
![[../attachments/Pasted image 20241007120650.png]]
# vim 救援回复
当我们在使用 vim 编辑时， vim 会在与被编辑的文件的目录下，再建立一个名为 .filename.swp 的文件。
若 vim 的工作被不正常的中断，导致暂存盘无法藉由正常流程来结束，暂存档就不会消失，当你再次打开原文件的时候，由于暂存盘存在的关系， vim 会主动的判断你的这个文件可能有些问题：![[../attachments/Pasted image 20241004113114.png]]

...
```
这个指令可以变更目前用户的有效群组，而且是另外以一个 shell 来提供这个功能，所以，以上面的例子来说， dmtsai 这个使用者目前是==以另一个 shell 登入的==，而且新的 shell 给予 dmtsai 有效 GID 为users ![[attachments/Pasted image 20241028122805.png]]
...
```
![[attachments/Pasted image 20241028124312.png]]

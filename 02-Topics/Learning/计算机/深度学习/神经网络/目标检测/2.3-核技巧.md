...
![[attachments/Pasted image 20240901103620.png]]
  ![[attachments/Pasted image 20240901103745.png]]
  那么如何得到新维度下向量 $T(\vec{x_{i}}),T(\vec{x_{j}})$ 的点积结果呢

##### 有两种方法：
  - 方法一： 定义相应的维度转换函数 $T$，对数据完成维度转换后再求新维度向量的点积
	  - ![[attachments/Pasted image 20240901104429.png]]
  - 方法二：直接套用核函数
	  - ![[attachments/Pasted image 20240901104552.png]]

###### 举个例子
![[attachments/Pasted image 20240901104959.png]]

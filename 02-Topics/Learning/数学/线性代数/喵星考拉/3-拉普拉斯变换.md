...
# 前置
![[attachments/Pasted image 20241108214230.png]]
![[attachments/Pasted image 20241108222030.png]]
...
![[attachments/Pasted image 20241109183647.png]]
# 代码, 偶函数与奇函数信号
![[attachments/Pasted image 20241109200628.png]]
她写得有点问题
```ad-col2
...
```
## 偶函数
 ![[attachments/Pasted image 20241109202210.png]]
...
## 奇函数
![[attachments/Pasted image 20241109202435.png]]

![[attachments/Pasted image 20241109204013.png]]
## 时域移动导致频域旋转
![[attachments/Pasted image 20241112101506.png]]
...
$$
## 频谱分析
![[attachments/Pasted image 20241112104011.png]]
$\cos{4\pi t}$ 是偶函数, 于是在虚部为 $0$, 实部的两个峰来源于它, $\sin{8\pi t}$ 是奇函数, 虚部的两个峰来源于它, $\sin(12\pi t+ \frac{\pi}{4})$ 则是在实部和虚部都有, 它是斜过来的
# 傅里叶变换的局限性
![[attachments/Pasted image 20241112104601.png]]
![[attachments/Pasted image 20241112104834.png]]
一个函数的傅里叶变换存在的必要条件就是函数必须要绝对可积, 也就是能量有限
![[attachments/Pasted image 20241112105111.png]]
![[attachments/Pasted image 20241112105151.png]] > [Site Unreachable](https://www.zhihu.com/question/20973620/answer/2418554267)
```ad-note
title: 正弦和余弦的频谱
collapse: closed
...
```
![[attachments/Pasted image 20241112110506.png]]
# 拉普拉斯变换
![[attachments/Pasted image 20241112110636.png]]
```ad-col2
![[Pasted image 20241112110915.png]]

![[Pasted image 20241112110931.png]]
```
  ![[attachments/Pasted image 20241112111055.png]]
  ![[attachments/Pasted image 20241112111937.png]]
![[attachments/Pasted image 20241112112052.png]]
![[attachments/Pasted image 20241112114133.png]]
## 和傅里叶变换的关系
 ![[attachments/Pasted image 20241112114721.png]]
 ![[attachments/Pasted image 20241112114946.png]]
## 线性变换特征
![[attachments/Pasted image 20241112115246.png]]
![[attachments/Pasted image 20241112115351.png]]
## 拉普拉斯变换的收敛域
 ![[attachments/Pasted image 20241112115627.png]]

...
# 前置内容
![[../attachments/Pasted image 20241028143029.png]]![[../attachments/Pasted image 20241028143119.png]]
...
3. 向量在原基下的坐标为 $\begin{bmatrix}a \\ b \\ c\end{bmatrix}$ ,在本空间的新基下的坐标为 $\begin{bmatrix}a & b & c\end{bmatrix}\begin{bmatrix}i' & j' & k'\end{bmatrix}=\begin{bmatrix}\hat{a} \\ \hat{b}  \\  \hat{c}\end{bmatrix}^{T}$, 这里得到了新的坐标, 接下来 $\begin{bmatrix}i & j & k\end{bmatrix}\begin{bmatrix}\hat{a}  \\ \hat{b}  \\  \hat{c}\end{bmatrix}=\begin{bmatrix}i & j & k\end{bmatrix}\begin{bmatrix}i & j & k\end{bmatrix}^{T}\begin{bmatrix}a \\ b \\ c\end{bmatrix}=\begin{bmatrix}a \\ b \\ c\end{bmatrix}$, 可以得到向量原本的值, 也是在原来基下的坐标 ![[../attachments/Pasted image 20241028145548.png]]
![[../attachments/Pasted image 20241028145837.png]] 长度为 1 是为了归一化
# 函数就是无穷维的数组
 - ! ![[../attachments/Pasted image 20241028150318.png]]
 ![[../attachments/Pasted image 20241028150752.png]]
![[../attachments/Pasted image 20241028151152.png]]
$$
...
![[../attachments/Pasted image 20241028152145.png]]
![[../attachments/Pasted image 20241028160019.png]]
...
## 复数, 复变函数的内积问题
- ! ![[../attachments/Pasted image 20241030113951.png]]
![[../attachments/Pasted image 20241030114613.png]]
# 工程学理论 - 微分方程
![[../attachments/Pasted image 20241030181501.png]]
# 差分和微分, 求和和积分
![[../attachments/Pasted image 20241030181756.png]]
![[../attachments/Pasted image 20241030182213.png]]
![[../attachments/Pasted image 20241030182605.png]]
## 求导和积分矩阵的特征向量
![[../attachments/Pasted image 20241030183205.png]]
什么样的函数, 在求导和积分下的形状是不变的?
指数求导和积分和形状是不变的, $\frac{da^{x}}{dx}=a^{x}\ln a$, 形状还是不变
![[../attachments/Pasted image 20241030183816.png]]
![[../attachments/Pasted image 20241030183944.png]]

## 三角函数和复指数的关系
![[../attachments/Pasted image 20241031115534.png]]
...
![[../../3B1B-微分方程/attachments/Pasted image 20240907093849.png]]
## 特征向量
![[../attachments/Pasted image 20241031121115.png]]
## 特征函数解微分方程
![[../attachments/Pasted image 20241031124442.png]]
![[../attachments/Pasted image 20241031195532.png]]
![[../attachments/Pasted image 20241031195837.png]]
![[../attachments/Pasted image 20241031200140.png]]
 这个时候函数的解变成了衰减震荡的一个形式了
### 带重根
![[../attachments/Pasted image 20241031200459.png]]
- ! ![[../attachments/Pasted image 20241031201240.png]]
# 正弦函数作正交基

 ![[../attachments/Pasted image 20241031202121.png]]
 这里一个是 $e^{-j…}$ 是因为复数内积有一个要取共轭
   ![[../attachments/Pasted image 20241031202927.png]]
...
![[../attachments/Pasted image 20241101114213.png]]
...
![[../attachments/Pasted image 20241101121112.png]]
- ! 这里有一个负频率的概念, 暂时不深究 [^2]
![[../attachments/Pasted image 20241101122044.png]]
![[../attachments/Pasted image 20241101122142.png]]
- @ 这里推了老半天, 终于推出来了, $\sin$ 有个负号的问题被 $j\cdot -j$ 抵消掉了: ![[../attachments/c92362b1b34cad1f343351a37b6cc00.jpg]]
- @ 算上 $a_{0}$, 和数学公式是一样的:
$$
...
$$
![[../attachments/Pasted image 20241101134816.png]]
...
![[../attachments/Pasted image 20241101134930.png]]
 # 傅里叶变换的公式推导
![[../attachments/Pasted image 20241101135723.png]]
![[../attachments/Pasted image 20241101135938.png]]
![[../attachments/Pasted image 20241101140150.png]]
![[../attachments/Pasted image 20241101140252.png]]

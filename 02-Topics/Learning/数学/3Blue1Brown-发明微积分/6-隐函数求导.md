...
![[attachments/Pasted image 20240625222814.png]]
但这里并不能按照之前的求导，不存在输入一个 $x$ 对应输出一个 $y$，$x$ 和 $y$ 是同时由一个等式定义而互相联系在一起的。这种曲线就是所谓的"隐函数曲线"（Implicit curve）
 
**相关变化率（Related rates）**
梯子问题：
![[attachments/Pasted image 20240625224222.png]]
比较梯子问题和圆切线问题，圆切线没有 $dt$
![[attachments/Pasted image 20240625224524.png]]
给表达式 $x^2+y^2$ 取名为 $S$
![[attachments/Pasted image 20240625225243.png]]
$$
...
# $\sin(x)y^2=x$
再来看 $\sin(x)y^2=x$
![[attachments/Pasted image 20240625230407.png]]
...
再来看视频解法：
![[attachments/Pasted image 20240626003139.png]]
$$
...
# 总结
![[attachments/Pasted image 20240626011459.png]]

...
![[attachments/Pasted image 20240626123301.png]]
...
![[attachments/Pasted image 20240626131531.png]]
...
当极限不存在时，你可以找到足够小的 $\epsilon$ ，使得无论你怎样缩小在 $0$ 点附近的范围，即无论 $\delta$ 多小，其对应的函数值范围都会太大 ![[attachments/Pasted image 20240626132830.png]]
# $L'Hôpital's rule$
...
观察三者的图像 ![[attachments/Pasted image 20240626134749.png]]
当 $x=1$ 时，$\sin(\pi x)$ 和 $x^2-1$ 都等于 $0$![[attachments/Pasted image 20240626135015.png]]
...
但你可以取 $x$ 为离 $a$ 十分相近的值，求 $x$ 逼近于 $a$ 时的极限值 ![[attachments/Pasted image 20240626141053.png]]
...
这个技巧其实是约翰·伯努利发现的，但洛必达是个土豪 ![[attachments/Pasted image 20240626141848.png]]
不知道分子的导数的话是没法用洛必达法则的：![[attachments/Pasted image 20240626142024.png]]
系统的无脑解法是不存在的
![[attachments/Pasted image 20240907090517.png]]
 ![[attachments/Pasted image 20240907090659.png]]
# 将(复杂的)函数和图像分解成简单的振荡的叠加
 ![[attachments/Pasted image 20240907090851.png]]
有更高频率的余弦函数衰减的更快
![[attachments/Pasted image 20240907091514.png]]
![[attachments/Pasted image 20240907091635.png]]
 ![[attachments/Pasted image 20240907091731.png]]
==将(复杂的)函数和图像分解成简单的振荡的叠加 ==
![[attachments/Pasted image 20240907091909.png]]
但是，它的起源却是一个看起来和频率和振荡毫无关系的物理问题

# 傅里叶级数
![[attachments/Pasted image 20240907092049.png]]
![[attachments/Pasted image 20240907092107.png]]
![[attachments/Pasted image 20240907092255.png]]
![[attachments/Pasted image 20240907092428.png]]
![[attachments/Pasted image 20240907092526.png]]
![[attachments/Pasted image 20240907092608.png]]
![[attachments/Pasted image 20240907092625.png]]
无穷项有理数的和是无理数，同理，无穷项像波一样的函数之和，可以真的等于一个不连续的平坦的函数
![[attachments/Pasted image 20240907092757.png]]
我们能否确认所有的函数都可以有类似的傅立叶级数吗？如果不能，何时不能？实分析这门学科的建立就是为了解答这类问题
![[attachments/Pasted image 20240907093318.png]]
![[attachments/Pasted image 20240907093333.png]]
![[attachments/Pasted image 20240907093440.png]]
![[attachments/Pasted image 20240907181322.png]] 
# 复平面中的旋转
 ![[attachments/Pasted image 20240907093849.png]]
   ![[attachments/Pasted image 20240907202851.png]]
   ![[attachments/Pasted image 20240907202905.png]]
   ![[attachments/Pasted image 20240907203058.png]]
   ![[attachments/Pasted image 20240907203315.png]]
   应该是余弦函数，不过都差不多
   ![[attachments/Pasted image 20240907203527.png]]
   $e^{i\cdot2t}+e^{-i\cdot2t}=2\cos{(2t)}$ 
   ![[attachments/Pasted image 20240907203936.png]]
## 为什么用复数而不是向量
   ![[attachments/Pasted image 20240907204052.png]]
   ![[attachments/Pasted image 20240907204312.png]]
   ```ad-col2
...
+为什么这个概念会对解微分方程举足轻重
```
![[attachments/Pasted image 20240907204545.png]]
```ad-col2
...
```
![[attachments/Pasted image 20240907205223.png]]
假如想让旋转速率为一圈每秒的向量从45度角开始旋转 +
![[attachments/Pasted image 20240907205514.png]]
  ![[attachments/Pasted image 20240907205608.png]]
  ![[attachments/Pasted image 20240907205648.png]]
  ![[attachments/Pasted image 20240907205912.png]]
  ![[attachments/Pasted image 20240907215710.png]]
## 求平均突出单一项
通过求平均的方法，我们去除了除了 $c_{0}$ 以外所有的项 
![[attachments/Pasted image 20240909214336.png]]
![[attachments/Pasted image 20240909214352.png]]
![[attachments/Pasted image 20240909214542.png]]
![[attachments/Pasted image 20240909215253.png]]
![[attachments/Pasted image 20240909215322.png]]
现在再求每一项的平均数，每一项比原先的多转两圈(顺时针)，所以平均数是 0，而 $c_{2}$ 的项不再转圈了，一直保持初始状态，也就求出了 $c_{2}$
![[attachments/Pasted image 20240909215731.png]]
 ```ad-col2
...
![[attachments/Pasted image 20240909220743.png]]
![[attachments/Pasted image 20240909220835.png]] 
输入值在 0 到 0.5 时，输出值就停在 1，当输入值在 0.5 到 1 时，输出值就停在 -1
![[attachments/Pasted image 20240909222241.png]]
![[attachments/Pasted image 20240909222323.png]]
![[attachments/Pasted image 20240909222342.png]]
![[attachments/Pasted image 20240909222405.png]]
![[attachments/Pasted image 20240909222445.png]]
即
$$
...
![[attachments/Pasted image 20240907093849.png]]  
![[attachments/Pasted image 20240909223913.png]]
## 解题
若定义域为 $[0,n]$
![[attachments/Pasted image 20240907092107.png]]

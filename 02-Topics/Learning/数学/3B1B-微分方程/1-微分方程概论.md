...
先来看个加速度的例子
它的导数是速度的垂直分量+
 ![[attachments/Pasted image 20240828095859.png]]
...
```
![[attachments/Pasted image 20240828102244.png]]
+或者说，只在（单摆摆动的）角度很小时才能近似成立
如果真的去测量一个单摆的话，你会发现当把它拉到更偏离原位置的时候，摆动周期会比中学物理公式算出来的更长
![[attachments/Pasted image 20240828102452.png]]
$x$ 可以写成 $\theta\cdot L$
![[attachments/Pasted image 20240828102616.png]]
...
即使没有空气阻力，这个公式也还是太难解了：![[attachments/Pasted image 20240828110112.png]]
 ![[attachments/Pasted image 20240828110346.png]]
  ![[attachments/Pasted image 20240828110517.png]]
![[attachments/Pasted image 20240828110605.png]]
$\theta'$ 是角速度
![[attachments/Pasted image 20240828110940.png]]
![[attachments/Pasted image 20240828111015.png]]
```ad-col2
...
```
 ...
 ![[attachments/Pasted image 20240828112548.png]]
  ![[attachments/Pasted image 20240828112651.png]]
```ad-col2
...
数学上我们经常把这样的空间称为"相空间“![[attachments/Pasted image 20240828113108.png]]
```ad-info
title: #待看
collapse: closed
...
1.  ![[attachments/Pasted image 20240828113931.png]]
2.  ![[attachments/Pasted image 20240828113945.png]]
3. ![[attachments/Pasted image 20240828114028.png]]
4. ![[attachments/Pasted image 20240828114047.png]]
5. ![[attachments/Pasted image 20240828114158.png]]
6. ![[attachments/Pasted image 20240828114219.png]]
7.  

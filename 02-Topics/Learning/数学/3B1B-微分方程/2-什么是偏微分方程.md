![[attachments/Pasted image 20240829200129.png]] ![[attachments/Pasted image 20240829200710.png]]
![[attachments/Pasted image 20240829200734.png]]
...
---
热传导方程：
![[attachments/Pasted image 20240829201307.png]]
```ad-col2
...
![[attachments/Pasted image 20240829203043.png]]
![[attachments/Pasted image 20240829203143.png]]
+它就要升温
![[attachments/Pasted image 20240829203241.png]]
速率与差值成正比
规范地用公式表示，则【T2关于时间的导数1】与【它自身和相邻点平均值的差值】成正比+ 
![[attachments/Pasted image 20240829203619.png]]
![[attachments/Pasted image 20240829203647.png]]
![[attachments/Pasted image 20240829203735.png]]
![[attachments/Pasted image 20240829203820.png]]
 ```ad-col2
 ![[Pasted image 20240829204040.png]]

![[Pasted image 20240829204100.png]]
```
 ![[attachments/Pasted image 20240829204141.png]]
```ad-col2
...
![[attachments/Pasted image 20240829223536.png]]

![[attachments/Pasted image 20240829223753.png]]
- & 思考：想一下，似乎某点会同时受到 $x$ 和 $y$ 两个方向的共四个点的温度影响，可以写成 $\Delta^{2}T_{x}(x,y)+\Delta^{2}T_{y}(x,y)$，比较温差可以相加，这样写没毛病，然后分成 $x$ 和 $y$ 两个角度看待，也是可以的
![[attachments/Pasted image 20240829223837.png]]
```ad-col2
...
+而是所有环绕着它的点
```
![[attachments/Pasted image 20240829224717.png]]
![[attachments/Pasted image 20240829224832.png]]
![[attachments/Pasted image 20240829225000.png]]